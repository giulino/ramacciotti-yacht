export type JournalCategory = 'Voyages' | 'Founder\'s Notes' | 'Partners' | 'News';
...
export const journalArticles: JournalArticle[] = [
	{
		...
		date: '2026-01-18',
		excerpt:
			'From Antigua to St. Barth, winter unfolds through warm trade winds, clear horizons, and unhurried days at sea.',
	...
	},
	{
		...
		date: '2026-01-30',
		excerpt:
			'A summer chapter shaped by emerald water, granite light, and evenings that linger long after the sun has set.',
	...
	},
	{
		...
		date: '2026-02-06',
		excerpt:
			'Portofino, Camogli, and the Cinque Terre reveal a coastline where elegance is measured in pace, not spectacle.',
	...
	},
	{
		...
		date: '2026-02-10',
		excerpt:
			'Why each charter is designed as the beginning of a relationship, not the end of a transaction.',
	...
	},
	{
		...
		date: '2026-02-12',
		excerpt:
			'How selected hospitality partners onshore extend the same discretion and care clients experience at sea.',
		image: '/images/hero/hero-02.jpg'
	},
	{
		...
		date: '2026-02-15',
		excerpt:
			'New itineraries for executive retreats and client hosting across the Mediterranean calendar.',
		image: '/images/hero/hero-01.jpg'
	}
];
